	...
	return (
		<div className="App">
			...
			<header className="App-header">
				...
				<Container className="my-2 bg-dark text-white" style={{ width: '1000px', height: '500px' }}>
					<div className='d-flex flex-column justify-content-center align-items-center' style={{ marginLeft: '30px' }}>
						<img src="nicklin13_portfolio/000.JPG" className="rounded-circle rounded-circle-small" style={{ objectFit: 'cover', objectPosition: 'center left' }} alt="圓形照片"></img>
				...
				<Container className="my-2 bg-dark text-white" style={{ width: '1000px', height: '400px' }}>
					<div className='col-md-8 d-flex flex-column justify-content-center' style={ {marginTop: '20px'} }>
						...
						<ul className='text-start fs-6' style={{ marginTop: '30px' }}>
							<li>Courses:
								...
								<span className="badge bg-secondary d-inline-block" style={{ marginLeft: '82px' }}>Computer Organization</span>
